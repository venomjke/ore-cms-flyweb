	...
	<div id="container">
		...
		<div class="logo">
			<a title="<?php echo Yii::t('common', 'Go to main page'); ?>" href="<?php echo Yii::app()->request->baseUrl; ?>/">
				<img alt="<?php echo CHtml::encode($this->pageDescription); ?>" src="<?php echo Yii::app()->request->baseUrl; ?>/uploads/logorusdom
				.png" height="90" width="200" id="logo" />
			</a>
		</div>
		<div id="user-cpanel">
        	<?php
                ...
                if(!isset($adminView)){
					?>
						...
						<img src="/uploads/numb3.png"><br />
						<!---<?php echo param("adminAddress"); ?> <br/>---> 
						<!--- <?php echo param("adminPhone"); ?> ---> 
						</p> 
					<?php
					/*
