...
class MainController extends ModuleUserController {
	...
	public function actionViewlist(){
		...
		$result = apartmentsHelper::getApartments(param('module_apartments_widgetApartmentsItemsPerPage', 10), 1, 0, null);
		$this->renderPartial('widgetApartments_list2', $result);
	}
