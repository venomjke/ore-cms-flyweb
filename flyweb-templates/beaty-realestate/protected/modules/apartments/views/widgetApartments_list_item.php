<div class="appartment_item <?php if ($item->is_special_offer) { echo 'special_offer_highlight'; } ?>" style="cursor:pointer" onclick="document.location='<?php echo $item->getUrl(); ?>'">
    <div class="offer">
