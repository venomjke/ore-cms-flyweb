...
class Controller extends CController {
	...
	function init() {
		...
		$this->aData['adminMenuItems'] = array(
			...
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_booking.png" />', 'url' => array('/booking/backend/main/admin'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('module_booking', 'Manage bookings'))),
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_payment.png" />', 'url' => array('/payment/backend/main/admin'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('module_payment', 'Manage payments'))),
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_users.png" />', 'url' => array('/users/backend/main/admin'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('common', 'User managment'))),
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_news.png" />', 'url' => array('/news/backend/main/admin'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('module_news', 'Manage news'))),
			array(
			...
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_references.png" />', 'url' => array('/site/viewreferences'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('common', 'Manage references'))),
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_qa.png" />', 'url' => array('/articles/backend/main/admin'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('module_articles', 'Manage FAQ'))),
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_admin_pass.png" />', 'url' => array('/adminpass/backend/main/index'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('module_adminpass', 'Change admin password'))),
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_settings.png" />', 'url' => array('/configuration/backend/main/admin'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('module_configuration', 'Settings'))),
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/manage_payment_settings.png" />', 'url' => array('/payment/backend/paysystem/index'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('module_payment', 'Payment System Settings'))),
			array('label' => '<img src="'.Yii::app()->request->baseUrl.'/images/adminmenu/news_product.png" />', 'url' => array('/news/backend/main/product'), 'linkOptions' => array('class' => 'adminMainNavItem', 'title' => Yii::t('module_news', 'News product')))
		);
